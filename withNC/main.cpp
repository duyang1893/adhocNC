...
int main (int argc, char *argv[])
{
	...
	cmd.AddValue ("percentage", "percentage of overshooting", percentage);
	...
	uint16_t MaxPacketSize = 1460;  // Back off 20 (IP) + 8 (UDP) + 12 (Seq) bytes from MTU
	...
	bLayerSent->SetOverhead (percentage);
